...
struct EIGEN_ALIGN16 PointXYZIRTS
{
    float x;
    float y;
    float z;
...
POINT_CLOUD_REGISTER_POINT_STRUCT(lidar_fusion::PointXYZIRTS,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (float, intensity, intensity)
                                  (std::uint16_t, ring, ring)
                                  (std::uint16_t, sensor_id, sensor_id)
                                  (float, time, time))
...
struct FusionDiagnosticSnapshot
{
